...
public class GuiCustomShareToLan extends GuiScreen {
    ...
    public GuiCustomShareToLan(GuiScreen p_i1055_1_) {
    ...
    public void initGui() {
        ...
        portTextField = new GuiTextField(105, fontRendererObj, this.width / 2 + 5, this.height - 53, 150, 20);
        portTextField.setMaxStringLength(5);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 102) {
            ...
            CustomLanModContainer.lanPort = Integer.valueOf(portTextField.getText());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, "Port number:", this.width / 2 - 30, this.height - 48, 16777215);
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        if (((int) typedChar >= 48 && (int) typedChar <= 57) || keyCode == Keyboard.KEY_LEFT || keyCode == Keyboard.KEY_RIGHT || keyCode == Keyboard.KEY_BACK || keyCode == Keyboard.KEY_DELETE) {
            this.portTextField.textboxKeyTyped(typedChar, keyCode);
            if (portTextField.getText().isEmpty() || portTextField.getText().equals("0")) {
                portTextField.setText("1");
            } else if (Integer.valueOf(portTextField.getText()) > 65535) {
                portTextField.setText("65535");
            }
    ...
    public void updateScreen() {
        portTextField.updateCursorCounter();
    }

    @Override
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        portTextField.mouseClicked(mouseX, mouseY, mouseButton);
